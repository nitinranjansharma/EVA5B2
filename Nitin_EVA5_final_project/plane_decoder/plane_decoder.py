...
class MaskRCNN(nn.Module):
    ...
    def __init__(self, config, ResNet_encoder, model_dir='test'):
        """
        ...
        self.set_log_dir()
        self.build(config=config,ResNet_encoder = ResNet_encoder)
        self.initialize_weights()
        self.loss_history = []
        self.val_loss_history = []

    def build(self, config,ResNet_encoder):
